...
export default function SearchInput({ onSearch }: { onSearch: (search: string) => void }) {
  ...
  return (
    <div className="flex-1 flex justify-center items-center relative">
      <input onChange={handleChange} value={query} type="text" className="flex-1 box-border shadow-md text-xl border border-solid border-gray-300 bg-white px-2 py-1.5 rounded-lg" placeholder="Search item" />
