...
export default function QRCodeModal({ amount, onClose }: { amount: number, onClose: () => void }) {
  ...
  return (
    <div className="fixed w-full h-full  left-0 top-0 bg-black/75 flex justify-center items-center gap-2">
      <div className="bg-white rounded-md p-4 flex flex-col gap-4 relative">
