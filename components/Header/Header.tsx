...
export default function Header({ title, titleSmall, action = <></> }: { title: React.ReactNode, titleSmall: string, action?: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <div ref={smallHeaderRef} className="mb-4 z-20 flex items-center gap-2 sticky top-0 h-12 -mx-4 px-4 text-2xl font-bold transition-[background-color,box-shadow] duration-300">
